...
public class Science_Quiz extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = firebaseDatabase.getReference("Quiz_Questions").child("Science");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science__quiz);
    ...
    private void uploadScore() {
        ...
        FirebaseDatabase.getInstance().getReference("Quiz Mark")
            ...
            public void onSuccess(Void aVoid) {
                ...
                Intent i = new Intent(Science_Quiz.this, Science_Rank.class);
                startActivity(i);
            }
        });
    }
