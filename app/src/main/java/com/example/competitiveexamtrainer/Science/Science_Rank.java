...
public class Science_Rank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science__rank);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Quiz Mark").child("Science");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(Science_Rank.this));
                ...
                markAdapter = new MarkAdapter(Science_Rank.this,mark_list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                dialog.dismiss();
                Toast.makeText(Science_Rank.this, "Something Wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
}