...
public class Maths_Quiz extends AppCompatActivity {

    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    DatabaseReference databaseReference = firebaseDatabase.getReference("Quiz_Questions").child("Maths");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maths__quiz);
    ...
    private void uploadScore() {
        ...
        FirebaseDatabase.getInstance().getReference("Quiz Mark")
            ...
            public void onSuccess(Void aVoid) {
                ...
                Intent i = new Intent(Maths_Quiz.this, Maths_Rank.class);
                startActivity(i);
            }
        });
    }
