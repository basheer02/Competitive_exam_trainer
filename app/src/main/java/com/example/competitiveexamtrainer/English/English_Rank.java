...
public class English_Rank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Quiz Mark").child("English");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(English_Rank.this));
                ...
                markAdapter = new MarkAdapter(English_Rank.this,mark_list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                dialog.dismiss();
                Toast.makeText(English_Rank.this, "Something Wrong", Toast.LENGTH_SHORT).show();
            }
        });
