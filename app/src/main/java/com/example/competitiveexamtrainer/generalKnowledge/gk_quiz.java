...
public class gk_quiz extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = firebaseDatabase.getReference("Quiz_Questions").child("General Knowledge");
    ...
    private void uploadScore() {
        ...
        FirebaseDatabase.getInstance().getReference("Quiz Mark")
            ...
            public void onSuccess(Void aVoid) {
                dialog.dismiss();
                Toast.makeText(getApplicationContext(),"Mark is Marked",Toast.LENGTH_SHORT).show();
                Intent i = new Intent(gk_quiz.this,GK_Rank.class);
                startActivity(i);
            }
        });
    }
