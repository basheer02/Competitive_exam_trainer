...
public class GK_Rank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_k__rank);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Quiz Mark").child("General Knowledge");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(GK_Rank.this));
                ...
                markAdapter = new MarkAdapter(GK_Rank.this,mark_list);
